...
public class Kellaritoiminnot {
     ...
     *
     * @param hakusana Käyttäjän syöttämä merkkijono, joka voi sisältää useita
     * sanoja.
     * @return Palauttaa ArrayListin, joka sisältää kaikki hakusanoja vastaavat
     * viinit.
     */
     ...
     *
     * @param avain merkkijono, jonka Arvio-olio saa Viiniltä, josta se on
     * Arvio. Arvion avain-kenttä toimii myös Arviot sisältävän HashMapin
     * avaimena.
     * @return ArrayList<Arvio> lista, joka sisältää kaikki yhdestä Viinistä
     * kirjoitetut Arviot.
     */
    ...
    public String viininKaikkiArviotString(String avain) {
        String kaikki = "";
        ArrayList<Arvio> lista = etsiArvioita(avain);
        if(lista==null) {
            return kaikki;
        }
        for(Arvio a : lista) {
    ...
    /**
     * lisää ohjelmaan uuden arvion. Uusi Arvio luodaan käyttäjän antaman
     * syötteen perusteella.
     *
     * @param avain talletettavan Arvio-olion avain, joka kertoo mihin viiniin
     * arvio liittyy.
    ...
    /**
     * lisää uuden Käyttäjän ohjelmaan, ArrayList tietorakenteeseen, joka
     * sisältää ohjelman kaikki käyttäjät.
     *
     ...
     *
     * @param tunnus merkkijono joka on Hankinnan omistavan Kayttajan
     * kayttajatunnus ja toimii HashMapin avaimena.
    ...
    /**
     * liittää Kellaritoiminnot luokkaan uuden Viini-olioita sisältävän
     * HashMapin.
     *
    ...
    /**
     * Etsii ohjelman tuntemien Kayttajien joukosta Kayttajan kayttajatunnuksen
     * perusteella.
     *
     * @param tunnus merkkijono, etsityn Kayttajan kayttajatunnus.
     * @return Kayttaja, jonka käyttäjätunnus on sama kuin parametri. Jos
     * Kayttajaa ei löydy, palauttaa null.
     */
